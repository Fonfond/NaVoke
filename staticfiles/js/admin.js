...
async function loadSettings() {
    try {
        ...
        document.getElementById('bannerEnabled').checked = settings.banner_enabled;
        document.getElementById('bannerTitle').value = settings.banner_title || '';
        document.getElementById('bannerSubtitle').value = settings.banner_subtitle || '';
        document.getElementById('bannerButtonText').value = settings.banner_button_text || '';
        document.getElementById('bannerImageUrl').value = settings.banner_image_url || '';
        document.getElementById('bannerLink').value = settings.banner_link || '';

        document.getElementById('deliveryFreeThreshold').value = settings.delivery_free_threshold || 800;
        document.getElementById('deliveryBaseCost').value = settings.delivery_base_cost || 150;

        document.getElementById('bonusEnabled').checked = settings.bonus_enabled;
        document.getElementById('bonusRate').value = settings.bonus_rate || 5;
        document.getElementById('bonusMinOrder').value = settings.bonus_min_order || 300;
        document.getElementById('bonusMaxPercent').value = settings.bonus_max_percent || 30;
        ...
        document.getElementById('notificationOrderSubject').value = settings.notification_order_subject || '';
...
async function saveAllSettings() {
    ...
    const data = {
        banner_enabled: document.getElementById('bannerEnabled').checked,
        ...
        bonus_rate: parseFloat(document.getElementById('bonusRate').value) || 5,
