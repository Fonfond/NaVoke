...
async function loadCatalog() {
    ...
    try {
        ...
        let filteredProducts = products.filter(product => {
            ...
            // ✅ ФИЛЬТР ПО ЦЕНЕ (ИСПРАВЛЕНО: используем min_price)
            const price = product.min_price || product.price || 0;
            // Если цена не указана (null/undefined), показываем товар
            if (product.min_price !== null && product.min_price !== undefined) {
                if (price < priceMin || price > priceMax) {
                    return false;
                }
            }
            // Если min_price === null, товар показываем всегда
        ...
        filteredProducts.sort((a, b) => {
            ...
            if (sort === '-price') return (b.min_price || 0) - (a.min_price || 0);
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product-card" onclick="window.location.href='/product/${product.id}/'">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-price">${product.min_price ? product.min_price + ' ₽' : '—'}</div>
